-- NOVA v7.0 SOUTH BRONX FILE | ESP / Aimbot / Misc / Farm (South Bronx: The Trenches)
...
print("[NOVA] v7.0 boot (southbronx file)")
...
local loading, spinRot, barFill, pct
do
...
-- UTILITY WORLD HELPERS (same as universal file)
